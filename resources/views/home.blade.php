...
<body>
    ...
    <div id="tentang-kami" class="tentang-kami-content">
        <h2>TENTANG KAMI</h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus ornare, augue eu rutrum commodo, dui diam
    ...
    <div id="berita-kami" class="berita-kami">
        ...
        <div class="berita-container">
            <div class="berita-card large">
                ...
                <div class="berita-card-content">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce scelerisque magna aliquet cursus
                        ...
                        Phasellus vestibulum turpis ac sem commodo, at posuere eros consequat.</p>
                    <a href="#">Baca selengkapnya</a>
                </div>
            </div>
            <div class="berita-card">
                <img src="gambar6.jpg" alt="Berita Image 2">
                <div class="berita-card-content">
                    <h3>LOREM IPSUM</h3>
            ...
            <div class="berita-card">
                <img src="gambar7.jpg" alt="Berita Image 3">
                <div class="berita-card-content">
                    <h3>LOREM IPSUM</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus ornare, augue eu rutrum
                        commodo,</p>
            ...
            <div class="berita-card">
                <img src="gambar9.jpg" alt="Berita Image 4">
                <div class="berita-card-content">
                    <h3>LOREM IPSUM</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus ornare, augue eu rutrum
                        commodo,</p>
            ...
            <div class="berita-card">
                <img src="gambar10.jpg" alt="Berita Image 5">
                <div class="berita-card-content">
                    <h3>LOREM IPSUM</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus ornare, augue eu rutrum
                        commodo,</p>
        ...
        <div class="gallery-container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item">
                    <img src="imm1.jpg" alt="Food 1">
                </div>
                <div class="gallery-item">
                    <img src="imm2.jpg" alt="Food 2">
                </div>
                <div class="gallery-item">
                    <img src="imm3.jpg" alt="Food 3">
                </div>
                <div class="gallery-item">
                    <img src="imm4.jpg" alt="Food 4">
                </div>
                <div class="gallery-item">
                    <img src="imm5.jpg" alt="Food 5">
                </div>
                <div class="gallery-item">
                    <img src="imm6.jpg" alt="Food 6">
                </div>
            </div>
